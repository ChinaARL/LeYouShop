...
import com.itheima.LySearchApplication;
...
import com.itheima.search.repository.GoodsIndexRespository;
...
public class FeingTest {
    ...
    public void test(){
        ...
        do {
            try {
                PageResult<SpuDTO> pageResult = itemClient.queryByPage(null, true, page, size);
                //处理返回SpuDTO对象
